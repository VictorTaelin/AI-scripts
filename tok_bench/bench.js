...
const MODELS = [
  ...
  { name: 'GPT 5.5',               spec: 'openai:gpt-5.5:low',                         pricing: { input: 2.50, output: 15.00 } },
  { name: 'GPT 5.5 (fast)',        spec: 'openai:gpt-5.5:low:fast',                    pricing: { input: 5.00, output: 30.00 } },
  { name: 'GPT 5.5 mini',          spec: 'openai:gpt-5.5-mini:low',                    pricing: { input: 0.75, output: 4.50 } },
  { name: 'GPT 5.5 mini (fast)',   spec: 'openai:gpt-5.5-mini:low:fast',               pricing: null },
